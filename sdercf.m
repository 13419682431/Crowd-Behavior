function [escaped_total,escaped_deriv,heat] = sdercf(grid, walls, exits, p, cf, cp, time, visualization)
...
% the exit. Before this time, the agents wander aimlessly. Lastly, there
